...
namespace Unity.MLAgents
{
    ...
    {
        [SerializeField] public DataDictionary s_SideChannelManagerRegisteredChannels = new DataDictionary();
        [SerializeField] public UdonQueue<CachedSideChannelMessage> s_SideChannelManagerCachedMessages//;
             = new UdonQueue<CachedSideChannelMessage>();
        ...
        {
            s_SideChannelManagerCachedMessages.InitializeUdonQueue(new CachedSideChannelMessage());
            ...
            SideChannelManager.RegisterSideChannel(this.s_SideChannelManagerCachedMessages,s_SideChannelManagerRegisteredChannels,new EngineConfigurationChannel());
            SideChannelManager.RegisterSideChannel(this.s_SideChannelManagerCachedMessages,s_SideChannelManagerRegisteredChannels, new TrainingAnalyticsSideChannel());
            m_EnvironmentParameters = new EnvironmentParameters();
            m_EnvironmentParameters.InitializeEnvironmentParameters(this.s_SideChannelManagerCachedMessages,this.s_SideChannelManagerRegisteredChannels);
            m_StatsRecorder = new StatsRecorder();
            m_StatsRecorder.InitializeStatsRecorder(this);
        ...
        public void EnvironmentStep()
        {
            using (m_StepRecursionChecker.Start())
            {
                ...
                if (!IsCommunicatorOn)
                {
                    SideChannelManager.GetSideChannelMessage(s_SideChannelManagerRegisteredChannels);
                }
        ...
        public void Dispose()
        {
            ...
            m_EnvironmentParameters.Dispose(this.s_SideChannelManagerRegisteredChannels);
            m_StatsRecorder.Dispose(this);
            SideChannelManager.UnregisterAllSideChannels(s_SideChannelManagerRegisteredChannels);  // unregister custom side channels
