...
namespace Unity.MLAgents.SideChannels
{
    ...
    public class FloatPropertiesChannel : SideChannel
    {
        ...
        [SerializeField] OutgoingMessage msgOut;
        public FloatPropertiesChannel()
        {
            ChannelId = UniqueIdManager.GenerateUniqueId();
        }
        ...
        public FloatPropertiesChannel(Guid channelId = default(Guid))
        {
            ...
            {
                ChannelId = k_FloatPropertiesDefaultId;// new Guid(k_FloatPropertiesDefaultId);
            }
            else
            {
