...
namespace Unity.MLAgents.Udon
{
    ...
    [Serializable]
    internal class AgentParameters : UdonSharpBehaviour
    {
        public int maxStep;
    }
    ...
    public class AgentUdon : UdonSharpBehaviour //, ISerializationCallbackReceiver, IActionReceiver, IHeuristicProvider
    {
        public string message = "Hello, VRChat!";

       
        [SerializeField] IPolicy m_Brain;
        [SerializeField] BehaviorParameters m_PolicyFactory;
/* 
             [SerializeField]
             [HideInInspector]
     ...
     //       [SerializeField] AgentInfo m_Info;
        ...
        /// </summary>
    //    [SerializeField] internal ISet<DemonstrationWriter> DemonstrationWriters = new HashSet<DemonstrationWriter>();
        ...
        /// </summary>
    //    [SerializeField] internal List<ISensor> sensors;

        /// <summary>
        /// VectorSensor which is written to by AddVectorObs
        /// </summary>
    //    [SerializeField] internal VectorSensor collectObservationsSensor;

        /// <summary>
        /// StackingSensor which is written to by AddVectorObs
        /// </summary>
    //    [SerializeField] internal StackingSensor stackedCollectObservationsSensor;

    //    [SerializeField] private RecursionChecker m_CollectObservationsChecker = new RecursionChecker("CollectObservations");
    //    [SerializeField] private RecursionChecker m_OnEpisodeBeginChecker = new RecursionChecker("OnEpisodeBegin");

        /// <summary>
        /// List of IActuators that this Agent will delegate actions to if any exist.
        /// </summary>
     //   [SerializeField] ActuatorManager m_ActuatorManager;
