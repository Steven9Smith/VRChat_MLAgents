...
namespace Unity.MLAgents
{
    ...
    public sealed class StatsRecorder
    {
        ...
        /// </summary>
        private StatsSideChannel m_m_Channel;
        internal StatsSideChannel m_Channel { get => m_m_Channel; }

        /// <summary>
        /// Constructor.
        /// </summary>
        internal void InitializeStatsRecorder(Academy academy)
        {
            m_m_Channel = new StatsSideChannel();
            SideChannelManager.RegisterSideChannel(
                academy.s_SideChannelManagerCachedMessages,
                academy.s_SideChannelManagerRegisteredChannels, m_Channel);
        }
        ...
        internal void Dispose(Academy academy)
        {
            SideChannelManager.UnregisterSideChannel(academy.s_SideChannelManagerRegisteredChannels,m_Channel);
        }
    }
}
