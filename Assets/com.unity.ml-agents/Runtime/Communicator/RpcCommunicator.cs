...
namespace Unity.MLAgents
{
    ...
    public class RpcCommunicator : ICommunicator
    {
        ...
        public bool Initialize(Academy academy, CommunicatorInitParameters initParameters, out UnityRLInitParameters initParametersOut)
        {
        ...
        {
            SideChannelManager.ProcessSideChannelData(academy.s_SideChannelManagerRegisteredChannels,rlInput.SideChannel.ToArray());
        ...
        void SendBatchedMessageHelper()
        {
            ...
            byte[] messageAggregated = SideChannelManager.GetSideChannelMessage(academy.s_SideChannelManagerRegisteredChannels);
