...
namespace Unity.MLAgents.Inference
{
    ...
    internal class TensorProxy
    {
        ...
        public long Height
        {
            get { return shape.Length >= 4 ? shape[shape.Length - 2] : 1; }
        }

        public long Width
        {
            get { return shape.Length >= 3 ? shape[shape.Length-1] : 1; }
        }
        ...
        public long Channels
        {
            get
            {
                return shape.Length >= 4 ? shape[shape.Length-3] :
                    shape.Length == 3 ? shape[shape.Length-2] :
