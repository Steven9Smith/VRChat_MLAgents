...
namespace Unity.MLAgents.Tests
{
    public class SamplerTests
    {
        ...
        public SamplerTests()
        {
            ...
            aca.LazyInitialize();
            m_Channel = SideChannelManager.GetSideChannel<EnvironmentParametersChannel>(aca.s_SideChannelManagerRegisteredChannels);
            // if running test on its own
            if (m_Channel == null)
            {
                //m_Channel = new EnvironmentParametersChannel();
                m_Channel.InitializeEnvironmentParametersChannel();// = new EnvironmentParametersChannel();
                SideChannelManager.RegisterSideChannel(aca.s_SideChannelManagerCachedMessages,aca.s_SideChannelManagerRegisteredChannels,m_Channel);
            }
        }
        ...
        public void UniformSamplerTest()
        {
            ...
            var aca = Academy.Instance;
            aca.LazyInitialize();
            SideChannelManager.ProcessSideChannelData(aca.s_SideChannelManagerRegisteredChannels, message);
            outgoingMsg.Dispose();
