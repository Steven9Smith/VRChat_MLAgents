...
namespace Unity.MLAgents.Tests
{
    ...
    public class EditModeTestInitialization
    {
        ...
        public void TestAcademy()
        {
            ...
            Assert.AreEqual(0, aca.StepCount);
            Assert.AreEqual(0, aca.TotalStepCount);
            Assert.AreNotEqual(null, SideChannelManager.GetSideChannel<EnvironmentParametersChannel>(aca.s_SideChannelManagerRegisteredChannels));
            Assert.AreNotEqual(null, SideChannelManager.GetSideChannel<EngineConfigurationChannel>(aca.s_SideChannelManagerRegisteredChannels));
            Assert.AreNotEqual(null, SideChannelManager.GetSideChannel<StatsSideChannel>(aca.s_SideChannelManagerRegisteredChannels));
        ...
        public void TestAcademyDispose()
        {
            var aca = Academy.Instance;
            aca.LazyInitialize();
            var envParams1 = SideChannelManager.GetSideChannel<EnvironmentParametersChannel>(aca.s_SideChannelManagerRegisteredChannels);
            var engineParams1 = SideChannelManager.GetSideChannel<EngineConfigurationChannel>(aca.s_SideChannelManagerRegisteredChannels);
            var statsParams1 = SideChannelManager.GetSideChannel<StatsSideChannel>(aca.s_SideChannelManagerRegisteredChannels);
            Academy.Instance.Dispose();

            aca = Academy.Instance;
            Academy.Instance.LazyInitialize();
            var envParams2 = SideChannelManager.GetSideChannel<EnvironmentParametersChannel>(aca.s_SideChannelManagerRegisteredChannels);
            var engineParams2 = SideChannelManager.GetSideChannel<EngineConfigurationChannel>(aca.s_SideChannelManagerRegisteredChannels);
            var statsParams2 = SideChannelManager.GetSideChannel<StatsSideChannel>(aca.s_SideChannelManagerRegisteredChannels);
            Academy.Instance.Dispose();
