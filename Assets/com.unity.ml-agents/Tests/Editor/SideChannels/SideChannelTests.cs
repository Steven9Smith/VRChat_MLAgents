...
namespace Unity.MLAgents.Tests
{
    ...
    {
        [SerializeField] OutgoingMessage outgoingMsg;
        [SerializeField] IncomingMessage incomingMsg;
        ...
        public class TestSideChannel : SideChannel
        {
            ...
            [SerializeField] OutgoingMessage msg;
            public TestSideChannel()
            {
                //ChannelId = new Guid("6afa2c06-4f82-11ea-b238-784f4387d1f7");
                ChannelId = "6afa2c06-4f82-11ea-b238-784f4387d1f7";
            }
        ...
        public void TestIntegerSideChannel()
        {
            ...
            var dictSender = new DataDictionary { { intSender.ChannelId, intSender } };
            var dictReceiver = new DataDictionary { { intReceiver.ChannelId, intReceiver } };
        ...
        public void TestRawBytesSideChannel()
        {
            ...
            var dictSender = new DataDictionary { { strSender.ChannelId, strSender } };
            var dictReceiver = new DataDictionary { { strReceiver.ChannelId, strReceiver } };
        ...
        public void TestFloatPropertiesSideChannel()
        {
            ...
            var dictReceiver = new DataDictionary { { propA.ChannelId, propA } };
            var dictSender = new DataDictionary { { propB.ChannelId, propB } };
        ...
        public void TestMessageReadWrites()
        {
            ...
            incomingMsg.InitializeIncomingMessage(outgoingMsg.ToByteArray());
